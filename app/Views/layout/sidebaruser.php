<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('main/dashboarduser') ?>">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?= base_url('main/dashboarduser') ?>">
